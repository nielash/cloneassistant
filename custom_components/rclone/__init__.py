...
type RcloneConfigEntry = ConfigEntry[RuntimeData]
...
async def async_setup_entry(
    ...
    """Set up a job integration from a config entry."""

    # Initialise the coordinator that manages data updates from the api.
    # This is defined in coordinator.py
    coordinator = RcloneCoordinator(hass, config_entry)
    ...
    # accessible throughout the integration
    ...
    # Return true to note a successful setup.
    return True
...
async def async_unload_entry(
    ...
    # This is called when you remove the integration or shutdown HA.
